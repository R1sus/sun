		...
		<form id="orderForm" name="orderForm">
			<fieldset class="step">
				...
				<div id="scrollbar">
					...
					<div class="inputNum">
						<input type="text" id="amount" maxlength="4" onfocus="if (this.value == '1200') {this.value=''}" onBlur="if (this.value == '') {this.value='1200'}"
										onchange="getValue(this);">
						<label for="amount">KWh</label>
						<img src="<?php echo get_template_directory_uri() ?>/images/homepage/info-icon.svg" id="info-img" />
					</div>
				</div>
			</fieldset>
			<fieldset class="step">
